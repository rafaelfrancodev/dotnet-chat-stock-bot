...
/// <summary>
/// Outcome of an operation that can fail in expected ways. Exceptions stay reserved for
/// genuinely exceptional situations (see the clean-code skill).
/// </summary>
public class Result
{
...
public sealed class Result<TValue> : Result
{
    ...
    /// <summary>The produced value. Throws when the result is a failure — always check <see cref="Result.IsSuccess"/> first.</summary>
